...
== Überschrift
Hier steht bloß Text. Ohne Schnickschnack und Sinn.
Überschriften werden auch gleichzeitig aufgelistet (rechts).
Überschriften erstellt man mit == [Text]
...
[IMPORTANT]
.Ein Eyecatcher
Möchte man etwas ganz besonders hervorheben #kann man es auch gelb markieren#.
====
...
Man kann sogar Checklisten erstellen
